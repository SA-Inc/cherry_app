const Seller  = {
  ...
  methods: {
    ...
    createSeller: function() {
      const url = 'http://192.168.0.105:5000/api/seller/create';
    ...
    getAllSellers: function() {
      const url = 'http://192.168.0.105:5000/api/seller/read_all'
    ...
    getSellerById: function(data) {
      ...
      const url = `http://192.168.0.105:5000/api/seller/read/${id_sell}`;
    ...
    updateSellerById: function(data) {
      ...
      const url = `http://192.168.0.105:5000/api/seller/update/${id_sell}`;
    ...
    deleteSellerById: function(data) {
      ...
      const url = `http://192.168.0.105:5000/api/seller/delete/${id_sell}`;
  ...
  mounted() {
    axios.get(`http://192.168.0.105:5000/api/seller/read_all`)
      .then(response => {
        if (Array.isArray(response.data.data)) {
          console.log('array');
          this.sellers = response.data.data;
