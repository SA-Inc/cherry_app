const Supplier  = {
  ...
  methods: {
    ...
    getAllWarehousesId: function() {
      const url = 'http://192.168.0.105:5000/api/warehouse/read_ids'
    ...
    createSupplier: function() {
      const url = 'http://192.168.0.105:5000/api/supplier/create';
    ...
    getAllSuppliers: function() {
      const url = 'http://192.168.0.105:5000/api/supplier/read_all'
    ...
    getSupplierById: function(data) {
      ...
      const url = `http://192.168.0.105:5000/api/supplier/read/${id_sup}`;
    ...
    updateSupplierById: function(data) {
      ...
      const url = `http://192.168.0.105:5000/api/supplier/update/${id_sup}`;
    ...
    deleteSupplierById: function(data) {
      ...
      const url = `http://192.168.0.105:5000/api/supplier/delete/${id_sup}`;
  ...
  mounted() {
    axios.get(`http://192.168.0.105:5000/api/supplier/read_all`)
      .then(response => {
        if (Array.isArray(response.data.data)) {
          console.log('array');
          this.suppliers = response.data.data;
