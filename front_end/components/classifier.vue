const Classifier  = {
  ...
  methods: {
    ...
    createClassifier: function() {
      const url = 'http://192.168.0.105:5000/api/classifier/create';
    ...
    getClassifierByCode: function(data) {
      ...
      const url = `http://192.168.0.105:5000/api/classifier/read/${code}`;
    ...
    updateClassifierByCode: function(data) {
      ...
      const url = `http://192.168.0.105:5000/api/classifier/update/${code}`;
    ...
    deleteClassifierById: function(data) {
      ...
      const url = `http://192.168.0.105:5000/api/classifier/delete/${id}`;
  ...
  mounted() {
    axios.get(`http://192.168.0.105:5000/api/classifier/read_all`)
      .then(response => {
        this.classifiers = response.data.data;
