insert_seller = "INSERT INTO seller (status_sell, FIO, value_product) VALUES (?, ?, ?);"
...
update_seller_by_id = "UPDATE seller SET status_sell = ?, FIO = ?, value_product = ? WHERE id_sell = ?"
